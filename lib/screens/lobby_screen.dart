                        ...
                        Container(
                          ...
                          child: Column(
                            ...
                            children: [
                              ...
                              _buildInstructionStep(context, '5', 'Guess when you think you know the person - careful, you can\'t change your answer'),
                              _buildInstructionStep(context, '6', 'Earn points for guessing as early as possible'),
                              _buildInstructionStep(context, '7', 'The player with the most points wins!'),
                            ],
                          ),
                        ),
                        ...
                        if (isCreator && players.length >= 1)
                          Padding(
                            ...
                            child: ElevatedButton(
                              onPressed: () => _startGame(context, gameService),
